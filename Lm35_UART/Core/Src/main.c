...
/* USER CODE BEGIN PV */
uint16_t value = 0;       // Stores ADC value
char uart_msg[50];        // Buffer to store UART messages
...
int main(void)
{
  ...
  /* USER CODE BEGIN 1 */
//	uint8_t msg=  // This Msg shown every time when the data is start receiving in UART
	  // For Collecting the Values of LM35 Sensor
